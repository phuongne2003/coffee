...
export default function Sidebar() {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      <div className={`flex items-center gap-3 px-4 py-5 border-b border-espresso-700 ${collapsed ? 'justify-center' : ''}`}>
        <div className="w-8 h-8 rounded-lg bg-terracotta flex items-center justify-center shrink-0">
          <ChefHat size={16} className="text-white" />
        </div>
        {!collapsed && (
          <div>
            <p className="font-serif text-cream-100 text-base font-semibold leading-tight">BrewDesk</p>
